    ...
    <aside className="sidebar">
      <Panel title="账户小卡" eyebrow="OUR ACCOUNTS" className="sidebar-card">
        <div className="mini-account">
          ...
          <div><strong>小熊</strong><span><CoinIcon currency="BEAR" size={20} /> 18 熊币</span><span>赚取并使用熊币</span></div>
        </div>
        <div className="mini-account">
          <CharacterIcon character="pig" size={46} />
          <div><strong>小猪</strong><span><CoinIcon currency="PIG" size={20} /> 85 猪币</span><span>赚取并使用猪币</span></div>
        </div>
      </Panel>
      ...
      <Panel title="今日汇率" eyebrow="EXCHANGE RATE" className="sidebar-card rate-card">
        ...
        <small>固定汇率仅用于商店定价，不开放币种兑换。</small>
      </Panel>
