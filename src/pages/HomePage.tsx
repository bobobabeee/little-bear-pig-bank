...
export default function HomePage({ currentUser }: { currentUser: UserId }) {
  return (
    <div className="page-stack home-page">
      ...
      <Panel title="快捷营业窗口" eyebrow="QUICK SERVICE">
        <div className="quick-actions">
          ...
          <a href="#pending"><span>!</span><strong>处理待办</strong><small>批准或退回</small></a>
        </div>
      </Panel>
      ...
      <div className="home-bottom-grid">
        <Panel title="待处理" eyebrow="ACTION INBOX / 03" className="pending-panel" >
          <div id="pending"><PendingPanel currentUser={currentUser} /></div>
        </Panel>
